...
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	for _, setup := range []func(ctrl.Manager) error{
		...
		backupsnapshotexportbucket.SetupWebhookWithManager,
		backupsnapshotexportjob.SetupWebhookWithManager,
		backupsnapshotrestorejob.SetupWebhookWithManager,
		provideraccessauthorization.SetupWebhookWithManager,
		provideraccesssetup.SetupWebhookWithManager,
		userorgassignment.SetupWebhookWithManager,
		userprojectassignment.SetupWebhookWithManager,
		userteamassignment.SetupWebhookWithManager,
		outagesimulation.SetupWebhookWithManager,
		...
		querylimit.SetupWebhookWithManager,
		rolemapping.SetupWebhookWithManager,
		...
		apikeyprojectassignment.SetupWebhookWithManager,
		auditing.SetupWebhookWithManager,
		...
		pushbasedlogexport.SetupWebhookWithManager,
		resourcepolicy.SetupWebhookWithManager,
		serviceaccount.SetupWebhookWithManager,
		serviceaccountaccesslistentry.SetupWebhookWithManager,
		serviceaccountprojectassignment.SetupWebhookWithManager,
		serviceaccountsecret.SetupWebhookWithManager,
		team.SetupWebhookWithManager,
		container.SetupWebhookWithManager,
		peering.SetupWebhookWithManager,
		invitation.SetupWebhookWithManager,
		regionalmode.SetupWebhookWithManager,
		resource.SetupWebhookWithManager,
		service.SetupWebhookWithManager,
		apikeyproject.SetupWebhookWithManager,
		invitationproject.SetupWebhookWithManager,
		ipaccesslist.SetupWebhookWithManager,
		serviceaccountproject.SetupWebhookWithManager,
		serviceaccountaccesslistentryproject.SetupWebhookWithManager,
		serviceaccountsecretproject.SetupWebhookWithManager,
		...
		projectassignment.SetupWebhookWithManager,
	} {
